...
export default function AdminUsersPage() {
  ...
  const handleTogglePermission = (moduleIndex: number, field: string) => {
    ...
    newPermissions[moduleIndex] = {
      ...newPermissions[moduleIndex],
      [field]: !(newPermissions[moduleIndex] as any)[field]
    };
    
    // If canEdit or canDelete is true, canView must be true
    if ((field === 'canEdit' || field === 'canDelete') && newPermissions[moduleIndex][field as keyof typeof newPermissions[0]]) {
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button 
                              ...
                              onClick={() => {
                                setFormData({
                                  ...formData,
                                  permissions: formData.permissions.map(p => ({ ...p, canView: true, canEdit: true, canDelete: true }))
                                });
                              }}
