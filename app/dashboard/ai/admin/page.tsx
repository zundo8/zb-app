      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-lg lg:text-xl font-bold text-foreground tracking-tight leading-none uppercase">Zica AI - Admin Panel</h1>
            <div className="flex items-center gap-2 mt-1.5">
              ...
              <p className="text-[9px] text-foreground/40 font-bold uppercase tracking-[0.2em]">
                {health?.status === "ok" ? "Zica AI Admin · Online" : health?.status === "error" ? "Zica AI · Configuration Error" : "Checking System..."}
              </p>
              {health?.status === "error" && (
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/dashboard/ai/user"
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-foreground/[0.04] border border-foreground/[0.08] text-foreground/60 hover:text-foreground/90 transition-all text-[10px] font-bold uppercase tracking-wider"
          >
            ...
            {!hasMessages && !isLoading && (
              ...
              >
                <div className="text-center space-y-3">
                  ...
                  <h2 className="text-xl font-bold text-foreground tracking-tight uppercase">Zica AI Admin Console</h2>
