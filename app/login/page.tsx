          ...
          {step === "PHONE" && (
            <div className="pt-2 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  <svg className="w-4.5 h-4.5 text-black/70 dark:text-white/80" viewBox="0 0 24 24">
                ...
                >
                  <svg className="w-4.5 h-4.5 text-black/70 dark:text-white/80" viewBox="0 0 24 24" fill="currentColor">
