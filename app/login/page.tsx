            ...
            {step === "PHONE" && (
              ...
              >
                ...
                <div className="login-divider-wrap">
                  ...
                  <span className="login-divider-text">OR CONNECT WITH</span>
                  <div className="login-divider-line" />
                </div>
                ...
                <div className="login-social-row">
                  ...
                  >
                    <svg className="login-social-icon-svg" viewBox="0 0 24 24">
                  ...
                  >
                    <svg className="login-social-icon-svg" viewBox="0 0 24 24" fill="currentColor">
